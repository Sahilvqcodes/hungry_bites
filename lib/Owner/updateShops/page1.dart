...
class UpdateShops extends StatefulWidget {
  UpdateShops({super.key});

  @override
  State<UpdateShops> createState() => _UpdateShopsState();
}

class _UpdateShopsState extends State<UpdateShops> {
                    ...
                    GestureDetector(
                      onTap: () {
                        if (_key.currentState!.validate()) {
                          Navigator.pushNamed(
                              context, "/owner_update_shops_page2",
                              arguments: {
                                "shops": shops,
